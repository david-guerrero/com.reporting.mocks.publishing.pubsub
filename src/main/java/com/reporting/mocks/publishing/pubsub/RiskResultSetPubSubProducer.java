...
public class RiskResultSetPubSubProducer {
    ...
    public RiskResultSetPubSubProducer(IResultPublisherConfiguration resultPublisherConfiguration, PubsubConfig appConfig) {
        producer = new PubSubProducer(resultPublisherConfiguration.getIntradayRiskSetTopic(), appConfig.getProjectId());
    }
