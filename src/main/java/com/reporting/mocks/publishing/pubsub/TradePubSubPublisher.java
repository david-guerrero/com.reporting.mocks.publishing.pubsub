...
public class TradePubSubPublisher {
    ...
    public TradePubSubPublisher(IResultPublisherConfiguration resultPublisherConfiguration, PubsubConfig appConfig) {
        producer = new PubSubProducer(resultPublisherConfiguration.getIntradayTradeTopic(), appConfig.getProjectId());
    }
